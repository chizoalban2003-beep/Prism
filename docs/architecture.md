...
| `kde_*` | HTTP server + CLI interface: REST API (`kde_server.py`), browser UI (`kde_ui.py`), config, profiles, and the `kde` / `prism` CLI entry points. |
...
┌─────────────────────────────────────────────────┐
│  Layer 1 — Interfaces                           │
│  kde_cli · kde_server · kde_ui · ksa_cli        │
├─────────────────────────────────────────────────┤
│  Layer 2 — Agent                                │
